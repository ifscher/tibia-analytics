...
def _authenticated_menu():
    ...
    st.sidebar.page_link("pages/backtests.py", label="Backtests", disabled=True)
    st.sidebar.page_link("pages/portfolios.py", label="Portfólios", disabled=True)
    st.sidebar.page_link("pages/real_time.py", label="Real Time", disabled=True)
    st.sidebar.page_link("pages/historico.py", label="Histórico", disabled=True)
    st.sidebar.page_link("pages/monte_carlo.py", label="Monte Carlo", disabled=True)
    st.sidebar.page_link("pages/base_de_dados.py", label="Base de Dados", disabled=True)
    st.sidebar.page_link("pages/volatilidade.py", label="Volatilidade", disabled=True)
    st.sidebar.page_link("pages/explorer.py", label="Explorer", disabled=True)
    st.sidebar.page_link("pages/wfa.py", label="WFA", disabled=True)
    
    st.sidebar.caption('Configurações')
    st.sidebar.page_link("pages/perfil.py", label="Perfil", disabled=True)
    st.sidebar.page_link("pages/acessos.py", label="Acessos", disabled=True)
